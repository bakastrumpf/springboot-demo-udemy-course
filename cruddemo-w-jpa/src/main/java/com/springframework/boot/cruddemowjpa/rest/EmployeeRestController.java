package com.springframework.boot.cruddemowjpa.rest;
...
import com.springframework.boot.cruddemowjpa.service.EmployeeService;
...
//	public EmployeeRestController(EmployeeDAO theEmployeeDAO) {
	...
	// refactor code to use service instead of dao
	@GetMapping("/employee")
	public List<com.springframework.boot.cruddemowjpa.entity.Employee> findAll(){
//		return employeeDAO.findAll();
	...
	public com.springframework.boot.cruddemowjpa.entity.Employee getEmployee(@PathVariable int employeeId) {
